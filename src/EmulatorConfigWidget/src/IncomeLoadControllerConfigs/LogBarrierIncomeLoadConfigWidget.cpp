#include "LogBarrierIncomeLoadConfigWidget.h"
...
LogBarrierIncomeLoadConfigWidget::LogBarrierIncomeLoadConfigWidget(QWidget* parent)
	: QWidget(parent)
{
	setupUi();
}

LogBarrierLoadControllerConfig LogBarrierIncomeLoadConfigWidget::getConfig() const
{
...
void LogBarrierIncomeLoadConfigWidget::setConfig(const LogBarrierLoadControllerConfig& cfg)
{
...
void LogBarrierIncomeLoadConfigWidget::setupUi()
{
	...
	auto* utilGroup = new QGroupBox(QString::fromLocal8Bit("Логарифмический барьер коллизий"), this);
	...
	utilLayout->addRow(QString::fromLocal8Bit("Вес коллизий (wCollision): "), _weightCollisionSpin);
	...
	setConfig(LogBarrierLoadControllerConfig());
}